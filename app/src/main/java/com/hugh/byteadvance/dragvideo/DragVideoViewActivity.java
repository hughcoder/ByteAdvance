...
public class DragVideoViewActivity extends AppCompatActivity implements DragVideoView.Callback, MediaPlayer.OnPreparedListener, TextureView.SurfaceTextureListener {

    private static final String TAG = DragVideoViewActivity.class.getSimpleName();
