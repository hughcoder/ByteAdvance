...
import com.hugh.byteadvance.hook.BinderProxyHookHandler;
 ...
 * @date 16/2/15
 */
public class WifiBinderHookHelper {

    public static void hookwiFiService() throws Exception {

        final String CLIPBOARD_SERVICE = "wifi";
        ...
        IBinder hookedBinder = (IBinder) Proxy.newProxyInstance(serviceManager.getClassLoader(),
                ...
                new WifiBinderProxyHookHandler(rawBinder));
