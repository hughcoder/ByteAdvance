...
import com.hugh.byteadvance.hook.BinderHookHandler;
...
public class WifiBinderProxyHookHandler implements InvocationHandler {
    ...
    public WifiBinderProxyHookHandler(IBinder base) {
        this.base = base;
        try {
            this.stub = Class.forName("android.content.IWifiManager$Stub");
            this.iinterface = Class.forName("android.content.IWifiManager");
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if ("queryLocalInterface".equals(method.getName())) {
            ...
            return Proxy.newProxyInstance(proxy.getClass().getClassLoader(),
                    ...
                    new WifiBinderHookHandler(base, stub));
        }
